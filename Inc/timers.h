...
inline void     xTmrCCR(uint32_t x) {TIM5->CCR4 = (x);}
inline void     xTmrPWMMode()       \
	{TIM5->CCMR2 = (TIM_CCMR2_OC4M_2 | TIM_CCMR2_OC4M_1);}
inline void     xTmrPWMEna()        {TIM5->CCER |= TIM_CCER_CC4E;}
inline void     xTmrPWMDis()        {TIM5->CCER &= ~TIM_CCER_CC4E;}
inline uint32_t xTmrReadCCR()       {return(TIM5->CCR4);}
...
inline void     step3TmrUpd()           {TIM4->EGR = TIM_EGR_UG;}
...
inline void     step3TmrPWMDis()        {TIM4->CCER &= ~TIM_CCER_CC2E;}
inline uint16_t step3TmrReadCCR()       {return(TIM4->CCR2);}
inline uint16_t step3TmrReadCCMR()      {return(TIM4->CCMR1);}

/* step4Tmr timer 3 pwm 2 */
...
inline void     step4TmrUpd()           {TIM3->EGR = TIM_EGR_UG;}
...
inline void     step4TmrPWMDis()        {TIM3->CCER &= ~TIM_CCER_CC2E;}
inline uint16_t step4TmrReadCCR()       {return(TIM3->CCR2);}
inline uint16_t step4TmrReadCCMR()      {return(TIM3->CCMR1);}

/* spindleTmr timer 8 pwm 4 */
...
#define SPINDLE_TMR_PWM 4

inline void     spindleTmrCCR(uint16_t x) {TIM8->CCR4 = (x);}
inline void     spindleTmrPWMMode()       \
	{TIM8->CCMR2 = (TIM_CCMR2_OC4M_2 | TIM_CCMR2_OC4M_1);}
inline void     spindleTmrPWMEna()        \
	{spindleTmrBDTR(); TIM8->CCER |= TIM_CCER_CC4E;}
inline void     spindleTmrPWMDis()        {TIM8->CCER &= ~TIM_CCER_CC4E;}
inline uint16_t spindleTmrReadCCR()       {return(TIM8->CCR4);}
...
inline void     indexTmrUpd()           {TIM10->EGR = TIM_EGR_UG;}
...
inline void     intTmrUpd()           {TIM11->EGR = TIM_EGR_UG;}
...
inline void     cmpTmrUpd()           {TIM9->EGR = TIM_EGR_UG;}
